...
class IndexAddConfig:
    ...
    update_features: Optional[List[str]] = field(
        default=None,
        metadata={"help": "Incrementally update existing after_pipeline_index.json files for selected features only. Supported: emotion, emotion_vlm, body_pose, mask_hole_quality."}
    )
