...
class TrainingPairGenerator:
    ...
    def _build_candidates(self, person_index: dict) -> Tuple[List[dict], dict]:
        ...
        for attrs in primary.values():
            ...
            face_quality_label = bool(attrs.get("quality_label", True)) and related_quality_label(attrs, "face_white")
            full_quality_label = related_quality_label(attrs, "full_orig") and related_quality_label(attrs, "full_white")
